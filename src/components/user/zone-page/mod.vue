        ...
        <el-main style="padding: 0 0 0 5px; overflow-x: hidden">
          ...
          <el-row :gutter="5">
            ...
            <el-col :span="10">
              <el-text>
                <el-icon>
                  <svg t="1691048283076" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="4474" width="200" height="200">
                    <path
                    ...
                    <path
                      ...
                      fill="#5D5D5D" p-id="4477"></path>
                  </svg> </el-icon>{{ x.likes_num }}
              </el-text>
            </el-col>
            ...
            <el-col :span="2">
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item @click="copytext(x.id)">复制链接</el-dropdown-item>
                    <el-dropdown-item @click="manageFileList(x.id, true)">文件列表</el-dropdown-item>
                    <el-dropdown-item disabled>发布</el-dropdown-item>
                    <el-dropdown-item divided @click="handleDelete(x.id)">删除</el-dropdown-item>
                  </el-dropdown-menu>
                </template>
              </el-dropdown>
            </el-col>
